 ...
 *
 * Focus trapping, focus restore on close, Escape handling, scroll locking,
 * and `aria-modal` wiring are all things a hand-rolled modal gets subtly
 * wrong; this app previously avoided the problem by having no modals at all
 * and expanding destructive forms inline instead.
 */
